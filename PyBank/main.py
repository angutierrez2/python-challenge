...
total_change = changes["Feb-10"] + changes["Mar-10"] + changes["Apr-10"] + changes["May-10"] + changes["Jun-10"] + changes["Jul-10"] + changes["Aug-10"] + changes["Sep-10"] + changes["Oct-10"] + changes["Nov-10"] + changes["Dec-10"] + changes["Jan-11"] + changes["Feb-11"] + changes["Mar-11"] + changes["Apr-11"] + changes["May-11"] + changes["Jun-11"] + changes["Jul-11"] + changes["Aug-11"] + changes["Sep-11"] + changes["Oct-11"] + changes["Nov-11"] + changes["Dec-11"] + changes["Jan-12"] + changes["Feb-12"] + changes["Mar-12"] + changes["Apr-12"] + changes["May-12"] + changes["Jun-12"] + changes["Jul-12"] + changes["Aug-12"] + changes["Sep-12"] + changes["Oct-12"] + changes["Nov-12"] + changes["Dec-12"] + changes["Jan-13"] + changes["Feb-13"] + changes["Mar-13"] + changes["Apr-13"] + changes["May-13"] + changes["Jun-13"] + changes["Jul-13"] + changes["Aug-13"] + changes["Sep-13"] + changes["Oct-13"] + changes["Nov-13"] + changes["Dec-13"] + changes["Jan-14"] + changes["Feb-14"] + changes["Mar-14"] + changes["Apr-14"] + changes["May-14"] + changes["Jun-14"] + changes["Jul-14"] + changes["Aug-14"] + changes["Sep-14"] + changes["Oct-14"] + changes["Nov-14"] + changes["Dec-14"] + changes["Jan-15"] + changes["Feb-15"] + changes["Mar-15"] + changes["Apr-15"] + changes["May-15"] + changes["Jun-15"] + changes["Jul-15"] + changes["Aug-15"] + changes["Sep-15"] + changes["Oct-15"] + changes["Nov-15"] + changes["Dec-15"] + changes["Jan-16"] + changes["Feb-16"] + changes["Mar-16"] + changes["Apr-16"] + changes["May-16"] + changes["Jun-16"] + changes["Jul-16"] + changes["Aug-16"] + changes["Sep-16"] + changes["Oct-16"] + changes["Nov-16"] + changes["Dec-16"] + changes["Jan-17"] + changes["Feb-17"]
